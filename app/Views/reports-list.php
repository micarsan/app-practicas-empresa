    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                    <div class="d-flex align-items-center">
                                        <h4 class="mb-0">Listado de reportes</h4>
                                        <a type="button" style="margin-left: 15px;" class="btn btn-primary reports-new" data-bs-toggle="modal" data-bs-target="#report-new" data-bs-whatever="@mdo"><i class="uil-file-plus-alt"></i> Nuevo</a>
                                    </div>
                ...
                <div class="modal fade" id="report-edit" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
